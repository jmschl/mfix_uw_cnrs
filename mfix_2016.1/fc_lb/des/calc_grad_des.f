...
!
! AB 30/5/16 (2016-1)forced CALC_GRAD_DES_CG because 
!                             _STD routine does not deal with NSW and non fluid cells in the domain
!                            tested
!                                                                      !
!^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^!
...
! AB _STD routine does not deal with NSW and non fluid cells in the domain
